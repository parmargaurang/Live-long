...
function doInsert(){
	...
	function doEdit(){
		...
		if ($_GET['actions']=='confirm') {
			...
			$sql = "INSERT INTO `messageout` (`MessageTo`, `MessageFrom`, `MessageText`) 
			VALUES ('" . $cur->PHONE . "', 'Janno', 
			'FROM Bachelor of Science and Entrepreneurs: Your order has been " . $status . ". The amount is " . $cur->PAYMENT . "')";
